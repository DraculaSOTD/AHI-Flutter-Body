...
For more information, please refer to <http://unlicense.org>
 ...
 Modified to use a 12 byte nonce.
*/
...
struct Chacha20
{
    ...
    {
        block.set_counter(nonce, counter);
    }
