...
class AHIBSPhoneHeightTipsBottomSheet(private val ahiTheme: AHITheme) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ahibs_phone_height_tips_bottom_sheet, container, false)
    }
    ...
    companion object {
        const val TAG = "AHIBSPhoneHeightTipsBottomSheet"
    }
